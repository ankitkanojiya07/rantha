  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23594D3C\" fill-opacity=\"0.4\"%3E%3Cpath d=\"M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')",
        }}
      ></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block">
            <span className="text-tiny text-[var(--color-text-secondary)] mb-2 block font-medium">Discover Our Heritage</span>
            <h2 className="heading-serif text-4xl md:text-5xl font-bold text-[var(--color-text-primary)] relative inline-block pb-2">
              About Ranthambore
              <span className={`absolute bottom-0 left-0 w-full h-1 bg-[var(--color-secondary)] transform origin-left transition-transform duration-1000 ease-out ${isVisible ? 'scale-x-100' : 'scale-x-0'}`}></span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className={`transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="space-y-6">
              ...
              <div className="pl-5 border-l-4 border-[var(--color-secondary)]">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              {[
                ...
                <div key={idx} className="bg-[var(--color-surface)] bg-opacity-70 backdrop-blur-sm p-4 rounded-lg shadow-sm border border-[var(--color-border)]">
                  <span className="text-small text-[var(--color-text-secondary)] block font-medium">{fact.label}</span>
          ...
          <div className={`transition-all duration-1000 delay-500 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="relative">
              ...
              {/* UNESCO Badge */}
              <div className="absolute -bottom-5 -right-5 bg-[var(--color-secondary)] text-[var(--color-surface)] p-4 rounded-lg shadow-lg transform rotate-3">
              ...
              {/* Location Badge */}
              <div className="absolute -top-5 -left-5 bg-[var(--color-surface)] text-[var(--color-text-secondary)] px-4 py-2 rounded-lg shadow-lg transform -rotate-3">
                <div className="flex items-center">
        ...
        <div className={`grid grid-cols-1 gap-8 mt-16 transition-all duration-1000 delay-700 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h3 className="text-2xl font-bold text-[var(--color-text-secondary)] mb-6 text-center">Exploring Ranthambore's Legacy</h3>
          
          {cardContent.map((card, index) => (
            <div 
              key={index}
              className={`bg-[var(--color-surface)] rounded-xl shadow-lg overflow-hidden transition-all duration-500 ${
                expandedCard === index ? 'ring-2 ring-[var(--color-secondary)]' : 'hover:shadow-xl'
              }`}
            >
              <div className={`${
                expandedCard === index 
                ...
                <div className={`${
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="bg-[var(--color-surface-alt)] p-2 rounded-full">
                      {card.icon}
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-[var(--color-text-primary)]">{card.title}</h3>
                      <p className="text-[var(--color-text-secondary)] font-medium">{card.subtitle}</p>
                    </div>
                  </div>
                  ...
                  <button 
                    className="mt-4 text-[var(--color-text-secondary)] font-bold hover:text-[var(--color-text-primary)] transition-colors inline-flex items-center gap-1 focus:outline-none focus:ring-2 focus:ring-[var(--color-secondary)] focus:ring-offset-2 rounded-md px-2 py-1"
        ...
        <div className={`mt-16 transition-all duration-1000 delay-900 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="bg-gradient-to-r from-[var(--color-surface)] to-[var(--color-surface-alt)] p-6 rounded-lg shadow-md border-l-4 border-[var(--color-secondary)]">
            <div className="flex items-start">
              <div className="bg-[var(--color-surface-alt)] p-2 rounded-full mr-4 mt-1">
                <Leaf size={24} className="text-[var(--color-text-secondary)]" />
              </div>
              <div>
                <h4 className="font-bold text-[var(--color-text-primary)] text-lg mb-2">Cultural Insight</h4>
